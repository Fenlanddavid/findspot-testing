  ...
  return (
    <div className="flex items-center gap-5">
        <svg width="60" height="60" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="logo-grad-card-v14" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stop-color="#10b981" />
              <stop offset="50%" stop-color="#14b8a6" />
              <stop offset="100%" stop-color="#0ea5e9" />
            </linearGradient>
          </defs>
          <circle cx="256" cy="256" r="200" stroke="url(#logo-grad-card-v14)" strokeWidth="32" fill="none" />
          <circle cx="256" cy="256" r="120" stroke="url(#logo-grad-card-v14)" strokeWidth="24" fill="none" opacity="0.6" />
          <circle cx="256" cy="256" r="50" fill="url(#logo-grad-card-v14)" />
          <rect x="244" y="20" width="24" height="80" rx="4" fill="url(#logo-grad-card-v14)" opacity="0.4" />
          <rect x="244" y="412" width="24" height="80" rx="4" fill="url(#logo-grad-card-v14)" opacity="0.4" />
          <rect x="20" y="244" width="80" height="24" rx="4" fill="url(#logo-grad-card-v14)" opacity="0.4" />
          <rect x="412" y="244" width="80" height="24" rx="4" fill="url(#logo-grad-card-v14)" opacity="0.4" />
        </svg>
        <div className="flex flex-col">
            <svg width="200" height="36" viewBox="0 0 200 36" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="findspot-text-grad-v11" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stop-color="#10b981" />
                  <stop offset="50%" stop-color="#14b8a6" />
                  <stop offset="100%" stop-color="#0ea5e9" />
                </linearGradient>
              ...
              <text 
                x="0" 
                y="30" 
                fill="url(#findspot-text-grad-v11)" 
                style={{ 
                    fontSize: '36px', 
                    fontWeight: 900, 
...
export const ShareCard = React.forwardRef<HTMLDivElement, ShareCardProps>((props, ref) => {
  const { find, photoUrl, permission, type } = props;
